  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <button className="shadow-button relative inline-block w-full rounded-md border border-black bg-gray-600 px-4 py-2 font-bold tracking-wide text-white no-underline hover:no-underline active:shadow-none">
